...
try:
    with connection.cursor() as cursor:
        ...
        for _ in range(50):
            ...
            # gender 추가
            gender = random.choice(['male','female']) # mysql w.b - ENUM으로 수정.
            ...
            cursor.execute("""
                INSERT INTO users (first_name, last_name, email, gender, password, address, contact, is_active, is_staff, is_orderable)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            """, (first_name, last_name, email, gender, password, address, contact, is_active, is_staff, is_orderable))
        ...
        products = [
            ...
            # 시그니처 메뉴 '명란젓-크림치즈 붕어빵' 추가
            ('Mentaiko-Cream cheese Bun', 'Rich cream cheese and spicy Mentaiko wrapped in a soft bun', 5.00)
        ]
